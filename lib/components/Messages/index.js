...
var _chatIcon = require('./../../assets/chat-icon.png');
...
var Message = function (_Component) {
  ...
  Message.prototype._renderMessageOfType = function _renderMessageOfType(type) {
    switch (type) {
      ...
      case 'buttons':
        return _react2.default.createElement(_ButtonMessage2.default, _extends({ onButtonClick: this.props.onButtonClick }, this.props.message));
      case 'action':
        return _react2.default.createElement(_ActionMessage2.default, this.props.message);
      default:
