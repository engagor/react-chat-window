...
var Message = function (_Component) {
  ...
  Message.prototype._renderMessageOfType = function _renderMessageOfType(type) {
    switch (type) {
      ...
      case 'buttons':
        return React.createElement(ButtonMessage, _extends({ onButtonClick: this.props.onButtonClick }, this.props.message));
      case 'action':
        return React.createElement(ActionMessage, this.props.message);
      default:
